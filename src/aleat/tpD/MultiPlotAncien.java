...
public class MultiPlotAncien {
	...
	public static void main(String[] args) {
		...
		MultiPlotAncien multi = new MultiPlotAncien();

		multi.nbGraduationX=8;

		//multi.addPlotable("Gauss", new CourbeDeGauss(100, -2, 2));
		//multi.addPlotable("Identité", new FonctionId(100, 0, 8));
		//multi.addPlotable("Constante", new FonctionConstante(20,-2,2,0.5));
		//multi.addPlotable("Cosinus", new Cosinus(50, 0, 8));
		multi.addPlotable("Gamma", new FonctionGamma(1,2,100, -2, 2));
	...
	private class PlotablePlus {
		...
		public PlotablePlus(String aName, Plotable aPlotable,JoinType joinType) {
