...
public class Histogramme implements Plotable {
	...
	public void setNombreDeBaton(int nombre) {
		...
		if (unBatonParEntier) throw new RuntimeException("vous avez décidé de mettre un baton par entier, vous ne pouvez pas appeler la méthode setNombreDeBaton");
		nbBaton = nombre;
	}


	public void setUnBatonParEntier(){
		if (nbBaton!=null) throw new RuntimeException("vous avez déjà fixé le nombre de battons. Nous ne pouvez pas appeler la méthode setUnBatonParEntier");
	...
	public static void main(String[] args) {
		...
		multiPlot.setStroke("test", MultiPlotAncien.thick);
		multiPlot.plotNow();
...
//
//		MultiPlotGrille multiPlot2 = new MultiPlotGrille();
//		multiPlot2.addPlotablePoint("test un baton par entier",hist2);
//		multiPlot2.setStroke("test un baton par entier",MultiPlotGrille.thick);
//
//		multiPlot2.plotNow();
