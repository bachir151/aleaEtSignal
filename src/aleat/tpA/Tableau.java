...
public class Tableau {
	...
	public static void main(String[] args) {
		...
		/*
		 * Déclaration d'une variable (pointeur) qui devra pointer sur un tableau d'entier
		 */
		int[] tableau;
		...
		/*System.out.println("en 0: " + tableau[0]);
		System.out.println("en 1: " + tableau[1]);
		System.out.println("en 2: " + tableau[2]);
  */
		/*
		 ...
		 */
		int[] tableau2 = { 5, 6, 9, 10 };

		/*
		 * Parcourons
		 */
		/*System.out.println("le tableau2:");
	...
	/*	System.out.println("\n le même tableau2 qu'on croiyait avoir modifié, mais en fait non");
		for (Integer elem : tableau2) {
			System.out.print(elem + ", ");

		}*/
		System.out.println("");
     //  System.out.println("hahahah " + tableau2[5]);
		/**
		 ...
		 */
		tableau3.remove(2);
		//System.out.println("le tableau 3 diminué: " + tableau3);

		/**
		 * Quel message renvoie l'ordinateur lorsque l'on déclare un pointeur,
		 * puis que l'on utilise ce pointeur sans y avoir affecter un objet.
		 * Exemple :
		 * 
		 * ArrayList<Integer> tableau4; tableau4.add(12);
		 * 
		 * Si vous débuter en programmation objet, vous ferez souvent cette
		 * erreur. Elle est assez aisé à débusquer : double cliquez sur le (bon)
		 * message d'erreur, il vous renverra à la bonne ligne.
		 */
		//ArrayList<Integer> tableau4; tableau4.add(12);
